...
/**
 * [2021-03-14 15:43:32]: Added for EKS.
 */
    ...
    constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
        ...
        fargatesvc.targetGroup.configureHealthCheck({
            ...
            timeout: Duration.seconds(4),
				...
				const eksCluster = new EKSClusterStack(this, 'CoffeeShopEKSCluster', vpc, props);
        ...
        codePipeline.addStage({
            ...
            actions: [sourceActionCodeCommit, sourceActionECR],
				...
				/**
				 * [2021-03-14 18:08:10] KSH:
				 * Add CodeBuild to deploy to EKS clsuter.
				 */
				/* 
				const eksProject = new codebuild.Project(
						this,
						'CoffeeEKSCodeBuildProject',
						{
								source: sourceOutputCodeCommit
						}
				) */
